...
symptoms = {
   ...
   "shivering": st.checkbox("Озноб (до дрожи)", key="shivering"),  # Shivering
    "chills": st.checkbox("Легкий озноб", key="chills"),  # Chills
